...
The one-page protocol spec is [`SPEC.md`](SPEC.md); this guide walks the bytes by
hand. For keeping a *running node* alive rather than reimplementing the protocol,
see [Continuity](continuity.html), which also indexes how the pieces fit together.
