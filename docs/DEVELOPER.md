...
<a class="list-row" href="state-machines.html"><div class="list-row-body"><span class="list-row-title">State machines</span><span class="list-row-subtitle">The ratchet and the mix, drawn from the transitions they actually take.</span></div></a>
