...
| A security maturity matrix (#278) | ⬜ | Per component: fuzzed / property-tested / independently reviewed / verified on hardware. Without it "the parser is audited" reads as "the protocol is audited", and the two are very far apart here — the parsers have had real adversarial attention and the crypto state machines have had none |
