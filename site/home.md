<div class="hero">
<h1>Messages that still get through</h1>
<p>SPORE is a shared delivery layer for your own devices. Notes, files and updates
hop across phones, a folder, a USB stick or a radio link — without an account and
without a company's server in the middle.</p>
...
<div class="col-4"><div class="card"><div class="card-body">
<h3 class="text-h5">Where it can travel</h3>
...
<p><a href="status.html">What works today →</a></p>
</div></div></div>
